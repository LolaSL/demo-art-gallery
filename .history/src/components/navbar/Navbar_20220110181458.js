            ...
            <Nav className="navbar navbar-expand-m"
                ...
                <Nav>
                    <div id="nav-button-en">
                        <Button type="button" className="btn btn-secondary navbar-btn" onClick={() => changeLanguage('en')}>EN</Button>
                    </div>
                    <div id="nav-button-ru">
                        <Button type="button" className="btn btn-secondary navbar-btn" onClick={() => changeLanguage('ru')}>RU</Button>
                    </div>
                </Nav>
            </Nav>
        </div>

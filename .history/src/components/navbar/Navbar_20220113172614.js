            ...
            <Nav className="navbar navbar-expand-sm"
                ...
                <Nav>
                    <div id="nav-button-en">
                        <Button type="button" className="btn btn-secondary font-weight-bold" onClick={() => changeLanguage('en')}>en</Button>
                    </div>
                    <div id="nav-button-ru">
                        <Button type="button" className="btn btn-secondary" onClick={() => changeLanguage('ru')}>ru</Button>
                    </div>
                </Nav>
            </Nav>
        </div>

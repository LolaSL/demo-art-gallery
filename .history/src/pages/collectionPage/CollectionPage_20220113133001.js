...
function CollectionPage() {
    ...
    return (
        <main className="container">
            ...
            {isLoading && < div className=" loader d-flex align-items-center py-2">
            ...
            <div className="row row-cols-1 row-cols-md-3 g-4 align-items-stretch justify-content-center mb-2">

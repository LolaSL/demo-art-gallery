            ...
            <div className="container-art">
                ...
                <div className='art  mb-4'>
                    <img className="img mx-auto d-block mb-4"
                        ...
                        object-fit="cover"
                        src={params.artView.image}
                        alt={params.artView.pictureName}></img>
                    <div className='art-info'>
                        ...
                        <div className=" blockquote text-justify font-italic">
                            <h4>{t("newArt.artist")} {params.artView.painter}</h4>
                            <h5>{t("newArt.lifeAndCountry")}{params.artView.lifeAndCountry}</h5>
                            <h6>{t("newArt.description")} {params.artView.body}</h6>
                            <h6>{t("newArt.dimention")} {params.artView.dimention}</h6>
                            <h6>{t("newArt.matherials")} {params.artView.matherial}</h6>
                            <h6 className="block mb-4 ">{t("newArt.date")} {params.artView.year}</h6>
                        </div>
                    </div>

    ...
    return isLoading ? (<div className="loader">{t("loader.loader")}</div>) :
        artView ? (
            <div className="container-art">
                <h2 className="art-title">{t("pictureInformation.title")}</h2>
                <div className='art  mb-4'>
                    ...
                    <div className='art-info'>
                        <div className=" blockquote text-center font-weight-bold my-2">
                            <h3 className="blockquote-header font-italic" style={{ textAlign: 'center' }}>{t("newArt.name")} {artView.pictureName}</h3>
                        </div>
